     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='yonghu'"  label="用户名" prop="yonghuming">
          <el-input v-model="ruleForm.yonghuming" readonly              placeholder="用户名" clearable></el-input>
                                          ...
                                          <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="家长姓名" prop="jiazhangxingming">
          <el-input v-model="ruleForm.jiazhangxingming"               placeholder="家长姓名" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="幼儿姓名" prop="youerxingming">
          <el-input v-model="ruleForm.youerxingming"               placeholder="幼儿姓名" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
